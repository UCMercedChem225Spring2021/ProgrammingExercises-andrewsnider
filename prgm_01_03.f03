<<<<<<< HEAD
      Program prgm_01_03
!
!     This program reads two 3x3 matrices from two seperate user-provided input files. After each
...
!
!     Call the subroutine PrintMatrix to print matrixInA ad matrixInB
!
      call PrintMatrix3x3(matrixInA)
      call PrintMatrix3x3(matrixInB)
!    
!     Form matrixProduct using the intrinsic function MatMul. Then,
!     print the result.
!
...
!
      ...
      return
      End Subroutine PrintMatrix3x3
>>>>>>> dc1bd851e3dfe945f50f692e8d044ecaa97a7e3f
